    ...
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-description">
          ...
          <span class="card-panel-num">{{total}}</span>
        </div>
      </div>
    </el-col>
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-icon-wrapper icon-money">
          <i class="el-icon-stopwatch card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">
            运行中
          </div>
          <span class="card-panel-num">{{running}}</span>
        </div>
      </div>
    </el-col>
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-description">
          ...
          <span class="card-panel-num">{{c}}</span>
        </div>
      </div>
    </el-col>
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-icon-wrapper icon-shopping">
          <i class="el-icon-discount card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">
            访问量
          </div>
          <span class="card-panel-num">{{d}}</span>
        </div>
      </div>
    </el-col>
  </el-row>
...
export default {
  ...
  mounted () {
    this.axios.get('/home/top').then(res => {
